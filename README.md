...
インベントリやコンテナ画面でアイテムへカーソルを合わせ、`Ctrl+C`で表示名をクリップボードへコピーするクライアント専用Mod
