...
val fmlVersion = when {
    minecraftVersion < org.gradle.util.GradleVersion.version("1.20.4") -> 1
    legacyMetadata -> 2
...
tasks.named<ProcessResources>("processResources") {
    val values = mapOf("version" to project.version, "minecraft" to project.property("minecraft_version"),
        ...
        "icon_property" to if (minecraftVersion >= org.gradle.util.GradleVersion.version("26.2")) "iconFile" else "logoFile",
