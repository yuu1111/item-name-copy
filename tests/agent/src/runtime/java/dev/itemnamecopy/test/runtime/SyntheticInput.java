...
final class SyntheticInput {
    ...
    int controlState() { return modifiers < 0 ? -1 : (modifiers & 2) == 0 ? 0 : 1; }
    int eventKey() { return modifiers < 0 ? -1 : 46; }
    int eventCharacter() { return modifiers < 0 ? -1 : 'c'; }
    int eventKeyState() { return modifiers < 0 ? -1 : action == 0 ? 0 : 1; }
    int repeatState() { return modifiers < 0 ? -1 : action == 2 ? 1 : 0; }
    int mouseX() { return pointerX; }
    int mouseY() { return pointerY; }
